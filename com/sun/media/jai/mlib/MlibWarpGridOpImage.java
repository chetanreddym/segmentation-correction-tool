  ...
  extends WarpOpImage
{
  ...
  protected void computeRect(Raster[] sources, WritableRaster dest, Rectangle destRect)
  {
    ...
    case 3: 
      if (setBackground) {
        for (int i = 0; i < dstMLI.length; i++) {
          Image.GridWarp2(dstMLI[i], srcMLI[i], xWarpPos, yWarpPos, source.getMinX(), source.getMinY(), xStart - x, xStep, xNumCells, yStart - y, yStep, yNumCells, filter, 0, intBackgroundValues);
      ...
      else
      {
        ...
        for (int i = 0; i < dstMLI.length; i++) {
          Image.GridWarp(dstMLI[i], srcMLI[i], xWarpPos, yWarpPos, source.getMinX(), source.getMinY(), xStart - x, xStep, xNumCells, yStart - y, yStep, yNumCells, filter, 0);
    ...
    case 5: 
      if (setBackground) {
        for (int i = 0; i < dstMLI.length; i++) {
          Image.GridWarp2_Fp(dstMLI[i], srcMLI[i], xWarpPos, yWarpPos, source.getMinX(), source.getMinY(), xStart - x, xStep, xNumCells, yStart - y, yStep, yNumCells, filter, 0, backgroundValues);
      ...
      else
      {
        ...
        for (int i = 0; i < dstMLI.length; i++) {
          Image.GridWarp_Fp(dstMLI[i], srcMLI[i], xWarpPos, yWarpPos, source.getMinX(), source.getMinY(), xStart - x, xStep, xNumCells, yStart - y, yStep, yNumCells, filter, 0);
        }
      }
