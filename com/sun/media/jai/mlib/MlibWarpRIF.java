  ...
  public RenderedImage create(ParameterBlock args, RenderingHints hints)
  {
    ...
    if ((warp instanceof WarpGrid)) {
      if ((interp instanceof InterpolationTable)) {
        return new MlibWarpGridTableOpImage(source, extender, hints, layout, (WarpGrid)warp, interp, backgroundValues);
      }
      



      return new MlibWarpGridOpImage(source, extender, hints, layout, (WarpGrid)warp, interp, filter, backgroundValues);
    }
    ...
    if ((warp instanceof WarpPolynomial)) {
      if ((interp instanceof InterpolationTable)) {
        return new MlibWarpPolynomialTableOpImage(source, extender, hints, layout, (WarpPolynomial)warp, interp, backgroundValues);
      }
      



      return new MlibWarpPolynomialOpImage(source, extender, hints, layout, (WarpPolynomial)warp, interp, filter, backgroundValues);
    }
