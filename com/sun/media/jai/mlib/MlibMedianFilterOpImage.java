  ...
  protected void computeRect(Raster[] sources, WritableRaster dest, Rectangle destRect)
  {
    ...
    for (int i = 0; i < dstML.length; i++) {
      ...
      case 3: 
        if (maskSize == 3)
        {
          Image.MedianFilter3x3(dstML[i], srcML[i], maskType, cmask, 0);
        ...
        {
          Image.MedianFilter5x5(dstML[i], srcML[i], maskType, cmask, 0);
        ...
        {
          Image.MedianFilter7x7(dstML[i], srcML[i], maskType, cmask, 0);
        ...
        else
        {
          ...
          Image.MedianFilterMxN(dstML[i], srcML[i], maskSize, maskSize, maskType, cmask, 0);
        }
      ...
      case 5: 
        if (maskSize == 3)
        {
          Image.MedianFilter3x3_Fp(dstML[i], srcML[i], maskType, cmask, 0);
        ...
        {
          Image.MedianFilter5x5_Fp(dstML[i], srcML[i], maskType, cmask, 0);
        ...
        {
          Image.MedianFilter7x7_Fp(dstML[i], srcML[i], maskType, cmask, 0);
        ...
        else
        {
          ...
          Image.MedianFilterMxN_Fp(dstML[i], srcML[i], maskSize, maskSize, maskType, cmask, 0);
        }
