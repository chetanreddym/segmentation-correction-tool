  ...
  extends MlibAffineOpImage
{
  ...
  protected void computeRect(Raster[] sources, WritableRaster dest, Rectangle destRect)
  {
    ...
    case 3: 
      ...
      if (setBackground) {
        Image.Affine2(dstML[0], srcML[0], medialib_tr, 0, 0, intBackgroundValues);
      ...
      else
      {
        ...
        Image.Affine(dstML[0], srcML[0], medialib_tr, 0, 0);
      }
    ...
    case 5: 
      ...
      if (setBackground) {
        Image.Affine2_Fp(dstML[0], srcML[0], medialib_tr, 0, 0, backgroundValues);
      ...
      else
      {
        ...
        Image.Affine_Fp(dstML[0], srcML[0], medialib_tr, 0, 0);
      }
