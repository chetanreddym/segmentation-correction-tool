  ...
  extends SimpleRenderedImage
{
  ...
  public BMPImage(InputStream stream)
  {
    ...
    if ((bitsPerPixel == 1) || (bitsPerPixel == 4) || (bitsPerPixel == 8))
    {
      ...
      if (bitsPerPixel == 8) {
        sampleModel = RasterFactory.createPixelInterleavedSampleModel(0, width, height, numBands);
      ...
      else
      {
        ...
        sampleModel = new MultiPixelPackedSampleModel(0, width, height, bitsPerPixel);
      }
      ...
      numBands = 3;
      sampleModel = new SinglePixelPackedSampleModel(1, width, height, new int[] { redMask, greenMask, blueMask });
      



      colorModel = new DirectColorModel(ColorSpace.getInstance(1000), 16, redMask, greenMask, blueMask, 0, false, 1);
      ...
      int[] bitMasks = { redMask, greenMask, blueMask, numBands == 3 ? new int[] { redMask, greenMask, blueMask } : alphaMask };
      


      sampleModel = new SinglePixelPackedSampleModel(3, width, height, bitMasks);
      



      colorModel = new DirectColorModel(ColorSpace.getInstance(1000), 32, redMask, greenMask, blueMask, alphaMask, false, 3);
