  ...
  implements ImageServer
{
  ...
  public synchronized void dispose(Long id)
    throws RemoteException
  {
  ...
  public int getMaxX(Long id)
    throws RemoteException
  {
    return getSource(id).getMaxX();
  }
  
  public int getMinY(Long id)
    throws RemoteException
  {
    return getSource(id).getMinY();
  }
  
  public int getMaxY(Long id)
    throws RemoteException
  {
    return getSource(id).getMaxY();
  }
  
  public int getWidth(Long id)
    throws RemoteException
  {
  ...
  public int getTileWidth(Long id)
    throws RemoteException
  {
    return getSource(id).getTileWidth();
  }
  
  public int getTileHeight(Long id)
    throws RemoteException
  {
  ...
  public int getMinTileX(Long id)
    throws RemoteException
  {
  ...
  public int getMinTileY(Long id)
    throws RemoteException
  {
  ...
  public int getMaxTileX(Long id)
    throws RemoteException
  {
    return getSource(id).getMaxTileX();
  }
  
  public int getMaxTileY(Long id)
    throws RemoteException
  {
  ...
  public SerializableState getColorModel(Long id)
    throws RemoteException
  {
    return SerializerFactory.getState(getSource(id).getColorModel(), null);
  }
  
  public Rectangle getBounds(Long id)
    throws RemoteException
  {
      ...
      if (pld != null)
      {
        ...
        if (paramNames != null) {
          for (int i = 0; i < paramNames.length; i++) {
            ...
            } catch (IllegalArgumentException iae) { Object currValue;
              continue; }
            Object currValue;
  ...
  public SerializableState getData(Long id)
    throws RemoteException
  {
  ...
  public boolean getRendering(Long id)
    throws RemoteException
  {
  ...
  public RenderedOp getNode(Long id)
    throws RemoteException
  {
  ...
  public synchronized void setRenderedSource(Long id, RenderedImage source, int index)
    throws RemoteException
  {
  ...
  public synchronized void setRenderedSource(Long id, RenderedOp source, int index)
    throws RemoteException
  {
    Object obj = nodes.get(id);
    if ((obj instanceof RenderedOp)) {
  ...
  public synchronized void setRenderedSource(Long id, Long sourceId, int index)
    throws RemoteException
  {
    Object obj = nodes.get(id);
    if ((obj instanceof RenderedOp)) {
  ...
  public boolean isDynamic(String opName)
    throws RemoteException
  {
  ...
  public synchronized SerializableState getInvalidRegion(Long id, ParameterBlock oldParamBlock, SerializableState oldRHints, ParameterBlock newParamBlock, SerializableState newRHints)
    throws RemoteException
  {
  ...
  public synchronized Long handleEvent(Long renderedOpID, int srcIndex, SerializableState srcInvalidRegion, Object oldRendering)
    throws RemoteException
  {
    RenderedOp op = (RenderedOp)nodes.get(renderedOpID);
    PlanarImage rendering = op.getRendering();
    ...
    PlanarImage oldSrcRendering = null;PlanarImage newSrcRendering = null;
  ...
  public void setServerNegotiatedValues(Long id, NegotiableCapabilitySet negotiatedValues)
    throws RemoteException
  {
