  ...
  extends Calendar
{
  ...
  private static final int[][] LIMITS = { { 0, 0, 0, 0 }, { 1, 1, 5000000, 5000000 }, { 0, 0, 11, 11 }, { 1, 1, 51, 52 }, { 0, 0, 5, 6 }, { 1, 1, 29, 30 }, { 1, 1, 354, 355 }, new int[0], { -1, -1, 4, 5 }, new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], { -5000001, -5000001, 5000001, 5000001 }, new int[0], { -5000000, -5000000, 5000000, 5000000 }, new int[0], new int[0] };
  ...
  {
    if (civil) {
      return (year - 1) * 354 + Math.floor((3 + 11 * year) / 30.0D);
    }
  ...
  {
    if (civil) {
      return Math.ceil(29.5D * month) + (year - 1) * 354 + Math.floor((3 + 11 * year) / 30.0D);
    }
  ...
  private static final long trueMonthStart(long month)
  {
    ...
    if (start == CalendarCache.EMPTY)
    {
      ...
      long origin = -42521587200000L + Math.floor(month * 29.530588853D - 1.0D) * 86400000L;
  ...
  {
    if (civil) {
      return 'Ţ' + (civilLeapYear(extendedYear) ? 1 : 0);
    }
  ...
  protected void handleComputeFields(int julianDay)
  {
    ...
    int year;
    int month; long monthStart; if (civil)
    {
      ...
      monthStart = Math.floor(months * 29.530588853D - 1.0D);
      
      if ((days - monthStart >= 28L) && (moonAge(internalGetTimeInMillis()) > 0.0D))
      {
        months++;
      }
