  ...
  extends JPanel
{
  ...
  public RangeSliderDemo() {
    ...
    rangeSliderValue1.setHorizontalAlignment(2);
    rangeSliderValue2.setHorizontalAlignment(2);
    ...
    add(rangeSliderLabel1, new GridBagConstraints(0, 0, 1, 1, 0.0D, 0.0D, 
      18, 0, new Insets(0, 0, 3, 3), 0, 0));
    add(rangeSliderValue1, new GridBagConstraints(1, 0, 1, 1, 0.0D, 0.0D, 
      18, 0, new Insets(0, 0, 3, 0), 0, 0));
    add(rangeSliderLabel2, new GridBagConstraints(0, 1, 1, 1, 0.0D, 0.0D, 
      18, 0, new Insets(0, 0, 3, 3), 0, 0));
    add(rangeSliderValue2, new GridBagConstraints(1, 1, 1, 1, 0.0D, 0.0D, 
      18, 0, new Insets(0, 0, 6, 0), 0, 0));
    add(rangeSlider, new GridBagConstraints(0, 2, 2, 1, 0.0D, 0.0D, 
