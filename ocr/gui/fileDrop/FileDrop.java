...
public class FileDrop
{
  ...
  private static Color defaultBorderColor = new Color(0.0F, 
    0.0F, 1.0F, 0.25F);
  ...
  public FileDrop(Component c, FileDropListenerInterface listener)
  {
  ...
  public FileDrop(Component c, boolean recursive, FileDropListenerInterface listener)
  {
  ...
  public FileDrop(PrintStream out, Component c, FileDropListenerInterface listener)
  {
  ...
  public FileDrop(PrintStream out, Component c, boolean recursive, FileDropListenerInterface listener)
  {
  ...
  public FileDrop(Component c, Border dragBorder, FileDropListenerInterface listener)
  {
  ...
  public FileDrop(Component c, Border dragBorder, boolean recursive, FileDropListenerInterface listener)
  {
  ...
  public FileDrop(PrintStream out, Component c, Border dragBorder, FileDropListenerInterface listener)
  {
  ...
  public FileDrop(final PrintStream out, final Component c, final Border dragBorder, boolean recursive, final FileDropListenerInterface listener)
  {
    if (supportsDnD()) {
            ...
            else
            {
              ...
              for (int zz = 0; zz < flavors.length; zz++) {
                if (flavors[zz].isRepresentationClassReader())
                {
                  ...
                  if (listener != null) {
                    listener.filesDropped(FileDrop.createFileArray(
                      br, out));
                  }
  ...
  private static File[] createFileArray(BufferedReader bReader, PrintStream out)
  {
    try {
      ...
      while ((line = bReader.readLine()) != null) {
        ...
        } catch (Exception ex) { log(out, "Error with " + line + ": " + ex.getMessage());
        }
      }
    ...
    implements Transferable
  {
    ...
    public static final DataFlavor DATA_FLAVOR = new DataFlavor(
      TransferableObject.class, "application/x-net.iharder.dnd.TransferableObject");
    ...
    public TransferableObject(Object data)
    {
      ...
      customFlavor = new DataFlavor(
        data.getClass(), "application/x-net.iharder.dnd.TransferableObject");
    }
    ...
    {
      this.fetcher = fetcher;
      customFlavor = new DataFlavor(dataClass, 
